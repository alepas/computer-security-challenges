...
class PasswordStrength {
    ...
    //The only controls that are done on the password are related to the quantity of different types of characters:
    //this function checks if the password contains more or less than 4 upper char, 2 lower char and 2 numbers and return the
    //string lenght.
